        ...
        <div>
            ...
            <dialog id="my_modal_5" className="modal">
                <div className="modal-box text-center p-6">
                    ...
                    <p className="text-2xl font-bold text-green-400 flex  justify-center items-center gap-4"><MdOutlineMarkEmailUnread className="text-green-500 text-3xl"></MdOutlineMarkEmailUnread>www.xyz@gmail.com</p>
